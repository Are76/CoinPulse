...
const CONFIG: Record<BadgeVariant, { label: string; color: string; bg: string; border: string; dot?: boolean }> = {
  "synced":             { label: "Synced",             color: "var(--status-fresh)",   bg: "rgba(74,222,128,0.09)",   border: "rgba(74,222,128,0.22)",   dot: true },
  "pending":            { label: "Pending",            color: "var(--status-warning)", bg: "rgba(245,158,11,0.09)",   border: "rgba(245,158,11,0.22)",   dot: true },
  "stale":              { label: "Stale",              color: "var(--status-stale)",   bg: "rgba(148,163,184,0.09)",  border: "rgba(148,163,184,0.2)" },
  ...
  "error":              { label: "Error",              color: "var(--status-danger)",  bg: "rgba(248,113,113,0.09)",  border: "rgba(248,113,113,0.22)", dot: true },
  "estimated":          { label: "Estimated",          color: "var(--accent-2)",       bg: "rgba(196,181,253,0.09)",  border: "rgba(196,181,253,0.2)" },
