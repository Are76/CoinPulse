...
- [x] Refresh stale planning docs or add status notes to them so reviewers do not mistake completed TanStack Query/pricing-status work for remaining work. (Done: status notes added to `docs/pnl-accounting-guardrails.md` §9 item 3 and `docs/frontend-query-standardization-audit.md` banner.)
